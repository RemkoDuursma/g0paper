...
\
The response of g~min~ to temperature is more complex; it shows both a response to instantaneous changes in temperature, as well as an acclimatory response to growth temperature. @riederer2001 and @schuster2016b have both demonstrated a steep non-linear instantaneous response of g~cut~ to temperature, with the response becoming especially steep at higher temperatures (> 40C). This high temperature increase may well be a crucial component of the ability of plants to tolerate heat waves [@drake]. In support of this idea, @schuster2016a reported on a correlation between thermal tolerance and g~min~ across nine species. The mechanism of the temperature response is complex, highly species-specific, and we refer to @schuster2016b for a detailed investigation. 

\
Less well established is the acclimatory potential of g~min~ to changes in growth temperature. We present a case study on *Eucalyptus parramattensis* grown in whole-tree chambers. The chambers either tracked ambient conditions, or were subjected to a persistent +3C warming treatment. After months of growth in the treatments, g~min~ was measured at various instantaneous temperatures, ranging from 17.5 to 27.5C. We found a 56% decrease in g~min~ in the elevated temperature trees, but there was no clear pattern with measurement temperature (Fig. 8). This decrease in g~min~ is consistent with the drought response, because again g~min~ is reduced in leaves that are subjected to conditions that increase evaporative demand (vapour pressure deficit was higher in the elevated temperature treatment, see @drake). The direction of this response is consistent with @duarte2016, who reported lower g~0~ and g~dark~ in a heat wave treatment (Douglas-fir), which persisted for some time. Responses across temperature gradients are more complex, in particular the change in g~min~ with altitude has been well studied. Commonly it is reported that g~min~ increases with altitude [e.g. @delucia1984; @herrick1991; @anfodillo2002]. @fernandez2017 discuss altitude responses in detail. and argue that the short growing seasons at high altitude are insufficient for complete maturation of leaf cuticles.


\
Finally we mention the striking effect of leaf age on g~min~. We have summarized five studies in Fig. S3, all of which reported on increased g~min~ for older leaves (but not for all species studied). The data reported by @jordan2007 is particularly impressive, as g~min~ in the herb *Agastachys odorata* gradually increased as leaves age. The most likely explanation for this change in g~min~ is the continued exposure to wind, rain, and abrasives, which have been shown to damage the cuticle and increase its conductance (see Section III). In plants that maintain several cohorts of leaves, finding an appropriate value of g~min~ for use in models will have to take into account the leaf age effect.
...
\
In a pioneering publication which presented the Jarvis model of stomatal conductance, @jarvis1976 states that "we have assumed in the following equations that when stomata are closed the leaf conductance is zero because field data are generally inadequate to define a cuticular conductance." Similarly, given the poor statistical properties of g~0~ estimated from regression, the very high values compared to minimum conductance reached for detached leaves, we conclude that g~0~ should not be estimated from regression on leaf gas exchange data for use in models. Then, how should g~0~ be estimated? It is clear from our comparisons that there is no single minimum conductance. Leaves maintain much higher g~dark~ (itself an actively controlled process) than the minimum obtained for detached leaves. Thus when modelling night-time or low-light conductance, a different g~0~ should be used than when modelling the drought response of plants. 

\
Our first conclusion is that g~0~, g~min~ and g~dark~ should not be assumed equal in any modelling study. Indeed, a productive way forward is to view each of these conductances as distinct, and they should be parameterized separately. For example, when considering modelling stomatal conductance with Eq. 1, we suggest that g~min~ and g~0~ can be combined: 

$$ g_s = g_{min} + (g_0 - g_{min}) + g_1 \frac{A_n}{C_a}f(D)$$

where g~min~ is parameterized with data obtained from mass loss of detached leaves (Fig. 6), representing a true whole-leaf minimum that is reached under drought conditions, and g~0~ is the minimum reached during low photosynthesis (due to low light or other factors) for well-watered plants. During drought, g~0~ will decrease [@misson2004], so that the true minimum reached for Eq. 1 is g~min~. 

\
It is however an open question on how g~min~ should be parameterized for different species, as we found both large variation between species that could not be explained by traits, and remarkable plasticity to growing conditions. Perhaps this plasticity is the reason that g~min~ did not vary predictably between species. We conclude as a result that g~min~ is not a "trait" in the sense that it can be meaningfully summarized for a given species, but has to be linked to growing conditions. Future studies should compare g~min~ on many species grown in the same conditions to better understand the adaptive value of the minimum water loss rate of leaves.
