...
\
A number of studies have assumed that the g~0~ in the Ball-Berry model equals the night-time conductance (g~dark~) [@barnard2013; @lombardozzi2017], simply because it is a condition when net photosynthesis is zero. However as our literature comparison showed (Fig. 1), g~dark~ is substantially higher compared to any other measure of minimum conductance. The simple idea that g~dark~ is equal to the minimum reached during periods of near-zero PPFD or high temperature during the day can be dismissed based on several observations.
