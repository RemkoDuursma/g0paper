...
\
Measurements of conductance of isolated, non-stomatal cuticles (g~cut~) were taken from the compilation by @kerstiens1996. Data on minimum conductance (g~min~) from weight loss of detached leaves was compiled from XXX papers, see Appendix. A compilation of night-time (and 'dark') conductance (g~dark~) values was taken from @lombardozzi2017. We also estimated g~0~ for each study included in a large database of leaf gas exchange data [@lin2015], by fitting Eq. 1 using the stomatal conductance model of @medlyn2011. These estimates were combined with the compilation of g~0~ values from @miner2017, who reported on xxx values from a literature compilation (each of those values was estimated with linear regression of the Ball-Berry model). Finally, we also estimated minimum values of g~s~ attained from the Lin et al. database, by taking those data where A~n~ < 2 $mu$ mol m^-2^ s^-1^, and calculating the minimum g~s~ for each of the XXX studies included in that dataset. This estimate was added as it represents an actual minimum values measured, rather than a fitted/extrapolated g~0~ term.

\
It is customary for g~cut~ and g~min~ to be expressed per unit total leaf surface area, however, since we aim a comparison with g~0~ and g~dark~, all values were converted to per unit projected surface area. Units were converted to molar fluxes assuming 41 mol m^-3^ (cf. @kerstiens1996). For the combined dataset, we looked up plant growth form and phylogenetic group (angiosperm or gymnosperm) from the TRY categorical traits database [@kattge2011], and taxonomic family and order with the taxize R package [@chamberlain2013].
...
The conductance of stomata-free leaf cuticles represents the absolute minimum conductance that leaves can attain. It is clear from our literature review, g~cut~ is very much lower than other definitions of minimum conductance - it is on average twice as low as g~min~. We admit some caution in this conclusion, because g~cut~ is probably too low in the way it is measured (as a permeance), due to low water content of the cuticle in those conditions [@kerstiens1996]. We briefly review a few important aspects of cuticular conductance, and to what extent we expect it to vary with species and environments. We refer to previous in-depth reviews for a more detailed treatment of other aspects of plant cuticles, such as chemical composition and morphology, and modes of water transport across the cuticle [@kerstiens1996; @kerstiens2006; @schreiber1996; @schreiber2001; @schuster2016b]. 

Although we use the term cuticular conductance freely, this transport pathway does not represent a true conductance since water does not diffuse as a gas through the cuticle. Instead, it dissolves into the medium of the cuticle, diffuses through the solid matrix, and is desorped at the outer edge of the cuticle. The main barrier to diffusion is actually a very thin layer at the leaf surface. Because most of the resistance is located in such a thin layer, g~cut~ does not depend on the thickness of the cuticle  [@riederer2001; @anfodillo2002]. One may ask why there is so much variation in cuticle thickness between plant species, if it does not affect g~cut~. The answer may lie in mechanical strength rather than water relations, as @onoda2012 reported that thicker cuticles are more resistant to tearing (the force to tear and tensile strength both approx proportional to cuticle thickness).

Despite considerable work on the topic, no clear relationship between chemical composition or structure of the cuticle and its conductance has emerged. Recently, @schuster2016a presented a comprehensive study of cuticle chemical composition, but this variation could not explain variation in cuticular conductance (gcutisol). Similarly, @hauke1998 found no relationship between the gradual decrease in g~cut~ in *Hedera helix* during leaf maturation and cuticle wax amount, mean chain lengths, or cuticle weight. 
...
This observation was used by @manzoni2011 to recalculate leaf water-use efficiency for droughted plants, but we caution against this because g~cut~ is only one component of g~min~, and CO~2~ will travel through leaky and incompletely closed stomata.
