...
\
Notes
gmin can increase with ozone and or aerosol particles (no ref yet) - potential for interaction with air pollution. Kerstiens?

Hoad et al; strong positive relationship between g0 and RWC - is our segmented linear method hiding changes in gmin over time?

Gardingen & Grace, gcut depends on VPD (and some useful discussion on difference isolated cuticle vs. intact leaf on non-stomatal side)

rawson and clarke 1988; gs increased hours pre-dawn in wheat. Nocturnal gs > cuticular (which was 13-50% of total)

hygen midgaard 1954- no effect of VPD on gmin (eventual decline in RWC is very linear and does not differ with various VPD treatments). "Experiments on the effect of darkening indicated that the stomata may remain partly open even during prolonged dark periods"

Mackova (Environmental and Experimental Botany Volume 86, February 2013, Pages 70-75): adding ABA to Lepidium sativum increased the chain length of cuticular waxes (but not total amounts). Other work has shown that the length of the chain decreases cuticular transpiration (they cite Hauke and Schreiber, 1998 Ontogenetic and seasonal development of wax composition and cuticular transpiration of ivy (Hedera helix L.) sun and shade leaves)
...
- @riederer2001 @schuster2016 correlation between temperature and gcut (non-stomatal cuticles)
